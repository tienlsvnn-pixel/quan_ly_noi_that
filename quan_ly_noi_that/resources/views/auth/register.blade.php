...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .register-card h3 { font-size: 30px; margin-bottom: 22px; }
        ...
        .hint, .field-error { font-size: 13px; }
        ...
        @media (max-width: 980px) {
            ...
            .showcase, .register-panel { padding: 30px 24px; }
        }

        @media (max-width: 640px) {
            body { padding: 14px; }
            .showcase, .register-panel { padding: 22px 18px; }
            .brand-row { flex-direction: column; align-items: flex-start; }
            .register-card h3 { font-size: 26px; }
        }
    </style>
</head>
<body>
        ...
        <section class="register-panel">
            <div class="register-card">
                <div class="brand-row">
                    ...
                    <div class="status-chip">Đăng ký tài khoản khách hàng</div>
                </div>
                ...
                <form method="POST" action="{{ route('register.submit') }}">
                    ...
                    <div class="field">
                        <div class="field-top">
                            ...
                            <span class="hint">Ví dụ: Nguyễn Văn An</span>
                        </div>
                    ...
                    <div class="field">
                        <div class="field-top">
                            ...
                            <span class="hint">Dùng để đăng nhập</span>
                        </div>
                        <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Nhập email của bạn" required>
                        @error('email')
                            <div class="field-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="field">
                        <div class="field-top">
                            ...
                            <span class="hint">Nhập lại mật khẩu</span>
                        </div>
                        <input id="password_confirmation" type="password" name="password_confirmation" placeholder="Xác nhận mật khẩu" required>
                    </div>

                    <button type="submit" class="submit-button">Đăng ký tài khoản</button>
                    <a href="{{ route('login') }}" class="ghost-button" style="display:grid; place-items:center;">Đã có tài khoản? Đăng nhập</a>
                </form>

                <div class="helper-panel">
                    <div class="helper-card">
                        <strong>Lưu ý</strong>
                        <span>Tài khoản mới dùng để xem sản phẩm và đặt hàng ngay sau khi đăng ký thành công.</span>
                    </div>
                </div>
            </div>
        </section>
