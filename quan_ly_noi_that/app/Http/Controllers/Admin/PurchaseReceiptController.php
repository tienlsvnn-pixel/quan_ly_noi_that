...
class PurchaseReceiptController extends Controller
{
    public function index(): View
    {
        ...
        $purchaseReceipts = PurchaseReceipt::with(['supplier', 'items'])
        ...
        return view('admin.purchase_receipts.index', compact('purchaseReceipts'));
    }
    ...
    public function create(): View
    {
        ...
        return view('admin.purchase_receipts.create', compact('suppliers', 'products'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'status' => ['required', Rule::in(PurchaseReceipt::STATUSES)],
    ...
    public function show(PurchaseReceipt $purchaseReceipt): View
    {
        ...
        return view('admin.purchase_receipts.show', compact('purchaseReceipt'));
    }

    public function update(Request $request, PurchaseReceipt $purchaseReceipt): RedirectResponse
    {
        $data = $request->validate([
            'status' => ['required', Rule::in(PurchaseReceipt::STATUSES)],
            'note' => ['nullable', 'string'],
        ...
        DB::transaction(function () use ($data, $purchaseReceipt) {
            ...
            if ($oldStatus !== PurchaseReceipt::STATUS_IMPORTED && $purchaseReceipt->isImported()) {
    ...
    private function applyReceiptStock(PurchaseReceipt $receipt): void
    {
    ...
    private function restoreReceiptStock(PurchaseReceipt $receipt): void
    {
        if (!$receipt->stock_applied) {
            return;
        }
